          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-[#999999] hover:text-[#D4AF37] hover:border-[#D4AF37]/30 transition-all">
